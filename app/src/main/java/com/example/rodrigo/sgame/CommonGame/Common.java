...
public class Common {
    ...
    private static float commonTime= 41.6f;
    ...
    private final static double[] JudgeSJ = {41.6, 41.6, 41.6, 83.3 + commonTime};
    private final static double[] JudgeEJ = {41.6, 41.6, 41.6, 58.3 + commonTime};
    private final static double[] JudgeNJ = {41.6, 41.6, 41.6, 41.6 + commonTime};
    private final static double[] JudgeHJ = {41.6, 41.6, 41.6, 25.5 + commonTime};
    private final static double[] JudgeVJ = {33.3, 33.3, 33.3, 8.5 + commonTime};
    private final static double[] JudgeXJ = {16.6, 16.6, 16.6, 16.6, 16.6 + commonTime};
    private final static double[] JudgeUJ = {8.3, 8.3, 8.3, 8.3, 8.3 + commonTime
    };
